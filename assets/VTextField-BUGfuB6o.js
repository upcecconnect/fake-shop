import { bi as isOn, bj as eventName, p as propsFactory, L as ref, aP as IN_BROWSER, aA as useToggleScope, M as watch, U as onScopeDispose, bk as destructComputed, bl as parseAnchor, bm as flipSide, bn as flipAlign, bo as flipCorner, r as computed, W as nextTick, bp as getAxis, aq as convertToUnit, s as clamp, b6 as watchEffect, bq as effectScope, br as defer, aZ as getCurrentInstance, a3 as inject, O as refElement, z as mergeProps, bb as matchesSelector, v as shallowRef, aw as useDisplay, N as onMounted, bs as reactive, af as provide, aY as toRaw, bt as readonly, m as makeComponentProps, ah as makeDimensionProps, i as makeThemeProps, b8 as makeTransitionProps, j as genericComponent, q as useProxiedModel, l as provideTheme, av as useRtl, a8 as useBackgroundColor, a2 as toRef, aj as useDimension, ar as onBeforeUnmount, ax as useRouter, y as useRender, a as createVNode, bu as Teleport, a$ as MaybeTransition, a4 as withDirectives, a5 as vShow, a9 as resolveDirective, F as Fragment, aD as Transition, bv as useBackButton, aT as EventProp, I as IconValue, aS as deepEqual, f as makeDensityProps, x as getUid, a1 as provideDefaults, a7 as Ripple, _ as filterInputAttrs, aa as VIcon, aK as useDensity, ba as wrapInArray, b2 as useTextColor, E as omit, k as useLocale, bw as VSlideYTransition, bx as getCurrentInstanceName, u as unref, aB as onBeforeMount, by as makeLoaderProps, C as makeRoundedProps, bz as useLoader, K as useRounded, bA as LoaderSlot, aX as VExpandXTransition, bB as pick, bC as Intersect, bD as cloneVNode, bE as callEvent } from "./index-DJXxASaI.js";
class Box {
  constructor(_ref) {
    let {
      x,
...
export {
  ...
  makeLazyProps as h,
  useLazy as i,
  makeVSelectionControlProps as j,
  VSelectionControl as k,
  makeSelectionControlGroupProps as l,
  makeVOverlayProps as m,
  VLabel as n,
  VSelectionControlGroup as o,
  VDivider as p,
  VTextField as q,
  imageEmpty as r,
  animate as s,
  deceleratedEasing as t,
  useScopeId as u,
  standardEasing as v,
  acceleratedEasing as w,
  getTargetBox as x,
