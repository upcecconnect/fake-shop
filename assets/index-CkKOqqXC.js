import { m as makeVOverlayProps, u as useScopeId, V as VOverlay, f as forwardRefs, a as asCurrency, b as makeVInputProps, c as makeVCheckboxBtnProps, d as useFocus, e as VInput, g as VCheckboxBtn, h as makeLazyProps, i as useLazy, j as makeVSelectionControlProps, k as VSelectionControl, l as makeSelectionControlGroupProps, n as VLabel, o as VSelectionControlGroup, p as VDivider, q as VTextField, r as imageEmpty } from "./VTextField-BUGfuB6o.js";
import { p as propsFactory, I as IconValue, m as makeComponentProps, f as makeDensityProps, g as makeSizeProps, h as makeTagProps, i as makeThemeProps, j as genericComponent, k as useLocale, l as provideTheme, q as useProxiedModel, r as computed, s as clamp, t as createRange, v as shallowRef, x as getUid, y as useRender, a as createVNode, F as Fragment, V as VBtn, z as mergeProps, b as createTextVNode, A as makeLocationProps, B as makePositionProps, C as makeRoundedProps, D as makeVariantProps, E as omit, G as useLocation, H as usePosition, J as useVariant, K as useRounded, L as ref, M as watch, N as onMounted, O as refElement, Q as genOverlays, S as VProgressLinear, T as VDefaultsProvider, U as onScopeDispose, W as nextTick, d as defineComponent, o as openBlock, c as createBlock, w as withCtx, e as createBaseVNode, u as unref, X as BasketIcon, Y as toDisplayString, Z as defineStore, _ as filterInputAttrs, $ as makeGroupProps, a0 as useGroup, a1 as provideDefaults, a2 as toRef, a3 as inject, a4 as withDirectives, a5 as vShow, a6 as VExpandTransition, a7 as Ripple, a8 as useBackgroundColor, a9 as resolveDirective, aa as VIcon, ab as makeElevationProps, ac as makeGroupItemProps, ad as useGroupItem, ae as useElevation, af as provide, ag as makeBorderProps, ah as makeDimensionProps, ai as useBorder, aj as useDimension, ak as useProductsListStore, al as storeToRefs, am as createElementBlock, an as renderList, ao as createCommentVNode, ap as CheckIcon, aq as convertToUnit, ar as onBeforeUnmount, as as CircularBuffer, at as makeDisplayProps, au as makeLayoutItemProps, av as useRtl, aw as useDisplay, ax as useRouter, ay as useSsrBoot, az as toPhysical, aA as useToggleScope, aB as onBeforeMount, aC as useLayoutItem, aD as Transition, aE as useCartStore, aF as VImg, aG as Menu2Icon, aH as pushScopeId, aI as popScopeId, aJ as _export_sfc } from "./index-DJXxASaI.js";
import { a as VCardItem, V as VCard, d as VRow, c as VCol, e as VAvatar, b as VCardText } from "./VCard-BOIdaK66.js";
...
const _hoisted_7$1 = { class: "text-decoration-line-through text-medium-emphasis" };
            ...
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_4$1, [
                createBaseVNode("div", _hoisted_5$1, [
                  ...
                  createBaseVNode("p", _hoisted_7$1, toDisplayString(unref(asCurrency)(__props.offerPrice)) + " UAH", 1)
                ]),
                createVNode(VRating, {
...
const _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", { class: "text-h1 mt-6" }, "There is no Product", -1));
const _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", null, "Try checking your spelling or use more general terms", -1));
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa2a2e37"]]);
export {
  index as default
};
