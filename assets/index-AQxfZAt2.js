          ...
          createVNode(VCardItem, { class: "pt-5" }, {
            default: withCtx(() => [
              ...
              createVNode(VSnackbar, {
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString(_ctx.$t("snackbar.card.number.copied.to.clipboard")), 1)
                ]),
                _: 1
              }, 8, ["modelValue"]),
                  ...
                  createVNode(VTable, null, {
                    default: withCtx(() => [
                      createBaseVNode("thead", null, [
                        ...
                        createBaseVNode("tr", null, [
                          createBaseVNode("th", null, toDisplayString(_ctx.$t("text.transaction.code")), 1),
                          createBaseVNode("th", null, toDisplayString(_ctx.$t("text.description")), 1),
                          createBaseVNode("th", null, toDisplayString(_ctx.$t("text.card.number")), 1)
                        ])
                      ]),
